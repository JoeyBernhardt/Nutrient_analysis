...
t.test(fd.null, mu = 0.6243078)


fd.null.50 <- as.vector(replicate(50, fd.exp(ntbl.matrix.mic, 29)))
hist(fd.null.50)
abline(v = 0.6243078, col = "red") #this is the value of FDiv I calculated for the US species

t.test(fd.null.50, mu = 0.6243078)
...
fd.null.cam <- as.vector(replicate(100, fd.exp(ntbl.matrix.mic, 4)))
mean(fd.null.cam)

t.test(fd.null.cam, mu = 0.9047908)
