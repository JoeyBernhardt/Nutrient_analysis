...
plot(spa.rand, ci.type = "bar", ci.col = "cadetblue", ylim = c(0,6), xlab = "number of fish species in diet", ylab = "number of distinct RDI targets reached", main = "25% RDI targets")
