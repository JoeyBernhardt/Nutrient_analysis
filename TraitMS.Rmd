...
start by discussing how variable nutrients are in the fish in our dataset, vs how variable they have been found to be in other studies (reference papers in stoich book)

**Variability in macroelements (C, N, P)**
-Vanni et al. 2002: found x order of magnitude of variation among X species in CN ratios
-Hendrixon et al. 2007: found this

**Variability in macronutrients (lipids, proteins etc.)**
-Spitz et al. 2010 found that lipid contents in 78 marine forage species were highly variable, ranging from 0.3-12% of body mass. 
-Childress et al. 1990 found that lipid content varies with depth preference, maybe due to differing metabolic requirements associated with living at depth. 
