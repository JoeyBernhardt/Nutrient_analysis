...
trad_nuts_mean <- read_csv("data-processed/traditional_foods_nutrients_cultures_all5.csv") %>% 
...
# mean_nuts <- read_csv("data-processed/mean_nuts_aug2020.csv") ## udpate aug 8 2020 "data-processed/mean_nuts_aug-26-2020.csv"
mean_nuts <- read_csv("data-processed/mean_nuts_aug-26-2020.csv") 
View(mean_nuts)
...
write_csv(all_trad_accum, "data-processed/trad_accumulation_replacement_sep2020.csv")

all_trad_accum <- read_csv("data-processed/trad_accumulation_replacement_sep2020.csv")
all_trad_accum %>% 
...
write_csv(all_b_params, "data-processed/replacement_design_accumulation_b_params_sep22.csv")

accum_b_params <- read_csv("data-processed/replacement_design_accumulation_b_params_sep22.csv")
...
write_csv(all_accumulation_lims, "data-processed/all_accumulation_lims-sep22.csv")
