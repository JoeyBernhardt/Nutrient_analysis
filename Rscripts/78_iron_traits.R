...
mods_iron <- get.models(msel_iron, subset= cumsum(weight) <= .95)
sw(mods_iron)
...
stargazer(mod1p, title = "", type = "html", out="tables/iron-pgls-all-parts-oct.htm", 
...
mod1 <- gls(log_concentration ~  body_part + feeding_mode + log_length + DemersPelag + bulk_trophic_level + realm + EnvTemp, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod2 <- gls(log_concentration ~  body_part + feeding_mode + log_length + EnvTemp + bulk_trophic_level + realm, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod2b <- gls(log_concentration ~  body_part + feeding_mode + log_length + EnvTemp + bulk_trophic_level, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod3 <- gls(log_concentration ~  body_part + feeding_mode + DemersPelag + bulk_trophic_level, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod4 <- gls(log_concentration ~  body_part + log_length + DemersPelag + bulk_trophic_level, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod5 <- gls(log_concentration ~  body_part + log_length + bulk_trophic_level, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod5b <- gls(log_concentration ~   log_length + bulk_trophic_level, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")

mod6 <- gls(log_concentration ~  body_part + log_length + feeding_mode, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod7 <- gls(log_concentration ~  body_part + bulk_trophic_level + feeding_mode, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod8 <- gls(log_concentration ~  body_part + log_length + DemersPelag, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod9 <- gls(log_concentration ~  body_part + feeding_mode + DemersPelag, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod10 <- gls(log_concentration ~  body_part + bulk_trophic_level + DemersPelag, corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod11 <- gls(log_concentration ~  body_part + log_length + EnvTemp, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod12 <- gls(log_concentration ~  body_part + feeding_mode + EnvTemp, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod13 <- gls(log_concentration ~  body_part + bulk_trophic_level + EnvTemp, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")


mod1b <- gls(log_concentration ~  feeding_mode + log_length + DemersPelag + bulk_trophic_level + realm + EnvTemp, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod2b <- gls(log_concentration ~  feeding_mode + log_length + EnvTemp + bulk_trophic_level + realm, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod2bb <- gls(log_concentration ~  feeding_mode + log_length + EnvTemp + bulk_trophic_level, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod3b <- gls(log_concentration ~  feeding_mode + DemersPelag + bulk_trophic_level, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod4b <- gls(log_concentration ~  log_length + DemersPelag + bulk_trophic_level, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod5b <- gls(log_concentration ~  log_length + bulk_trophic_level, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod6b <- gls(log_concentration ~  log_length + feeding_mode, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod7b <- gls(log_concentration ~ bulk_trophic_level + feeding_mode, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod8b <- gls(log_concentration ~  log_length + DemersPelag, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod9b <- gls(log_concentration ~  feeding_mode + DemersPelag, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod10b <- gls(log_concentration ~  bulk_trophic_level + DemersPelag, corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod11b <- gls(log_concentration ~  log_length + EnvTemp, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod12b <- gls(log_concentration ~  feeding_mode + EnvTemp, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")
mod13b <- gls(log_concentration ~  bulk_trophic_level + EnvTemp, correlation = corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")



mod14 <- gls(log_concentration ~  1, corPagel(value = 0, phy = iron_all_tree, fixed = TRUE), data = iron_allg2, method = "ML")




R2(mod11, phy = iron_all_tree)

### model selection
msel_iron_all <- model.sel(mod1, mod2, mod3, mod4, mod5, mod6, mod7, mod8, mod9, mod10, mod11, mod12, mod13, mod2b, mod14,
                           mod1b, mod3b, mod4b, mod5b, mod6b, mod7b, mod8b, mod9b, mod10b, mod11b, mod12b, mod13b, mod2bb, rank = AICc) 

msel_iron_all2 <- model.sel(mod1, mod2, mod3, mod4, mod5, mod6, mod7, mod8, mod9, mod10, mod11, mod12, mod13, mod2b, mod14,
...
model_table_iron_all <- msel_iron_all2 %>% 
  t() %>% 
  as.data.frame() %>% 
  mutate(term = rownames(.)) %>% 
  dplyr::select(term, everything())

str(model_table_iron_all)


confints_iron_all <- data.frame(confint(model.avg(get.models(msel_iron_all, subset = cumsum(weight) <= .95))),
                            estimate = coef(model.avg(get.models(msel_iron_all, subset = cumsum(weight) <= .95)))) %>% 
  mutate(term = rownames(.)) %>% 
  rename(lower = X2.5..) %>% 
  rename(upper = X97.5..) %>% 
  mutate(nutrient = "iron") %>% 
...
iron_all_outputs <- full_join(confints_iron_all, model_table_iron_all, by = c("term2" = "term")) %>% 
  left_join(., iron_all_weights) %>% 
...
iron_plot_all <- confints_iron_all %>% 
  filter(term != "(Intercept)") %>% 
  ggplot(aes(x = term, y = estimate)) + 
  geom_pointrange(aes(x = term, y = estimate, ymin = lower, ymax = upper)) +
  coord_flip() +
